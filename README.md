# Main NPC behavior scripts:
## [MainManager](https://github.com/firancly/spanish-store/blob/main/src/ServerScriptService/MainManager.server.luau) - responsible for NPC spawn rate, collisions
